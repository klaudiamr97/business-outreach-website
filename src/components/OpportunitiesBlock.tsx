...
const OpportunitiesBlock: React.FC<OpportunitiesProps> = ({
    title,
    opportunities,
}) =>{
    return (
        <div className="flex flex-col md:flex-row md:space-x-12 mx-8 mt-10 md:mx-10 md:mt-16 lg:mx-20 lg:mt-24">
            ...
            {opportunities?.map((opportunity, index)=>(<li key={index} className="flex flex-col"><span className="text-h5 pb-4">{opportunity.label}</span><p className="text-p">{opportunity.description}</p></li>
